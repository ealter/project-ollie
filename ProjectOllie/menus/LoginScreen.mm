...
{
    if (self = [super init]) {
        nameField = [self addTextFieldWithFrame:CGRectMake(self.contentSize.height*3/5, self.contentSize.width/2, 150, 30)];
        nameField.placeholder = @"Username";
        nameField.delegate    = self;
        
        pwField = [self addTextFieldWithFrame:CGRectMake(self.contentSize.height*2/5, self.contentSize.width/2, 150, 30)];
